...
public class ServerGreeter extends Thread {
	...
	public void run() {
		...
		while(bool) {
			...
			try {
				...
				DataInputStream streamer = new DataInputStream(sock2.getInputStream());
				//12. Print the message from the DataInputStream object using the readUTF() method
				System.out.println(streamer.readUTF());
	...
	public static void main(String[] args) {
		...
		try {
			ServerGreeter boi = new ServerGreeter();
			boi.run();
		} catch (IOException e) {
